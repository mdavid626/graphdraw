...
namespace SevenZ.Calculator
{
   public partial class Calculator
   {
      ...
      public static class Token
      {
         ...
         public const string Sine = "sin", Cosine = "cos", Tangent = "tg", CoTangent = "cotg",
                    ASine = "arcsin", ACosine = "arccos", ATangent = "arctg", ACoTangent = "arccotg",
         ...
         static string[] FunctionList = new string[] { Sine, Cosine, Tangent, CoTangent, ASine, ACosine, 
                                                       ATangent, ACoTangent, Log, Log10, Ln, Exp, Abs, 
                                                       Sqrt, Root };
